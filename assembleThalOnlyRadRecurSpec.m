...
specification.connections(1).mechanism_list={...
    'iGABAA_TC_TRN_radrecur',...
    'iGABAB_TC_TRN_radrecur',...
    };
specification.connections(2).direction='TRN<-TRN';
specification.connections(2).mechanism_list={'iGABAA_TRN_TRN_radrecur'};
specification.connections(3).direction='TRN<-TC';
specification.connections(3).mechanism_list={'iAMPA_TRN_TC_radrecur'};
