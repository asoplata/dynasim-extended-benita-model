function specification = assembleNoise(numCellsScale)
%ASSEMBLENOISE - Construct and connect the cortex of the (Benita et al., 2012) model with the thalamus of (Soplata et al., 2017)
%
