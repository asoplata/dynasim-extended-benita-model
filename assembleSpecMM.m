function specification = assembleSpecMM(dt, numCellsScaledown)
%ASSEMBLESPECMM - Construct and connect the cortex of the (Benita et al., 2012) model but with MM GABA synapses
%
